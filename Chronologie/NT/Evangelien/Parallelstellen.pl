...
my $reich               = $gl->add_horizontal_track();
my $v_gap_3             = $gl->add_horizontal_track();
my $weiteres            = $gl->add_horizontal_track();


$reich        ->area($joh_tut_busse      , $joh_tut_busse      )->{html} = 'J.d.T: Tut Busse, Reich Nahe';
$reich        ->area($teufel_zeigt_reiche, $gap_teufel         )->{html} = 'Teufel zeigt Reiche';
$reich        ->area($jesus_tut_busse, $jesus_tut_busse        )->{html} = 'Jesus: Tut Busse, Reich Nahe';
$reich        ->area($glueckselig, $glueckselig)->{html} = 'Glückselig, … denn ihrer ist das Reich (Mt 5:3)';
$reich        ->area($sprecht_reich_nahe, $sprecht_reich_nahe)->{html} = 'Sprecht: Reich nahe (Mt 10:7)';
$reich        ->area($reich_nahe, $reich_nahe)->{html} = 'Wenn ich … austreibe, … Reich nahe (Mt 12:28)';
$reich        ->area($petrus_schluessel, $petrus_schluessel)->{html} = 'Petrus erhält die Schl. d. R. (Mt 16:19)';
$reich        ->area($koenig_rechnet_ab, $koenig_rechnet_ab)->{html} = 'R. einem König gl. gew., der mit seinem Knechten abrechnet (Mt 18:23)';
$reich        ->area($kindlein, $kindlein)->{html} = 'Lasst die Kindlein zu mir kommen… ihrer ist das Reich Gottes. (Mt 19:14)';
$reich        ->area($reicher_reich, $reicher_reich)->{html} = 'Ein Reicher kommt schwer ins Reich d. Himmer (Mt 19:23)';
$reich        ->area($reich_weggenommen, $reich_weggenommen)->{html} = 'Das Reich wird weggenommen und anderer Nation gegeben, die Früchte bringt (Mt 21:43)';
$reich        ->area($reich_auf_erdkreis_gepredigt, $reich_auf_erdkreis_gepredigt)->{html} = 'Reich wird auf ganzem Erdkreis gepredigt, dann Ende (Mt 24:14)';
